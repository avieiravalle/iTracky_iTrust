              ...
              {showTransaction.type === 'EXIT' && (
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select name="status" data-testid="select-status" required className="w-full px-4 py-3 bg-gray-50 dark:bg-zinc-800 rounded-xl border-none focus:ring-2 focus:ring-black/5 dark:focus:ring-white/5 outline-none appearance-none dark:text-white">
                  ...
                  <div>
                    ...
                    <input name="client_name" data-testid="input-client-name" className="w-full px-4 py-3 bg-gray-50 dark:bg-zinc-800 rounded-xl border-none focus:ring-2 focus:ring-black/5 dark:focus:ring-white/5 outline-none dark:text-white" placeholder="Opcional" />
                  </div>
                </div>
              )}
              <div className="flex gap-3 pt-4">
