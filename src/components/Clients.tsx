...
// Supondo que você tenha essas funções no seu arquivo de utilitários
// Se não, você pode criá-las ou adaptar.
...
export const Clients: React.FC<{ token: string }> = ({ token }) => {
